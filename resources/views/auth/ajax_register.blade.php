                        ...
                        <form class="form-horizontal" id="registration" method="POST" action="{{ url('/users/register') }}" data-parsley-validate>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <button type="submit" class="btn btn-primary ladda-button" data-style="expand-right" data-size="s" data-color="green">
                                        <i class="fa fa-btn fa-user"></i> Register
                                    </button>
                                    <a href="/login/facebook">
                                        <div class="btn btn-md btn-primary ladda-button" data-style="expand-right" data-size="s" data-color="blue">
